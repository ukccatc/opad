...
class ThemeUpdateChecker {
	public $theme = 'aocean';  //The theme associated with this update checker instance.
	public $metadataUrl = 'http://www.modernwpthemes.com/demo/aocean/metadata.json';  //The URL of the theme's metadata file.
