        ...
        <header class="page-header">
				<h1 class="page-title">
					<?php
						...
						elseif ( is_day() ) :
							printf( __( 'День: %s', 'modernwpthemes' ), '<span>' . get_the_date() . '</span>' );

						elseif ( is_month() ) :
							printf( __( 'Месяц: %s', 'modernwpthemes' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );

						elseif ( is_year() ) :
							printf( __( 'Год: %s', 'modernwpthemes' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
