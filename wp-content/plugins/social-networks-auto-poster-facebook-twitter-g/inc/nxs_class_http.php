...
File Version: 1.0.10 (Feb 16, 2018)
...
if (!class_exists('nxs_Http')){ class nxs_Http { private $headers = '';
    function request( $url, $args = array() ) {  global $nxs_version;
        $defaults = array( 'method' => 'GET', 'timeout' =>'5', 'redirection' => '0', 'httpversion' => '1.1', 'user-agent' => 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.54 Safari/537.36',
